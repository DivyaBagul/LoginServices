package com.example.loginconsumer;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void btnSend(View view) {
        c = Calendar.getInstance();//used to get current date
    ...
    protected void onStart() {
        super.onStart();
        // Bind to the service
        Intent intnt = new Intent("com.example.loginservices.logService");
        intnt.setPackage("com.example.loginservices");
